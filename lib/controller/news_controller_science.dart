...
class NewsControllerScience extends GetxController {
  ...
  Future<void> fetchData(
    ...
    final url = Uri.parse(
      'https://gnews.io/api/v4/top-headlines?apikey=c7fe32e58235bade6f251558389282ec&lang=ar&category=science');
